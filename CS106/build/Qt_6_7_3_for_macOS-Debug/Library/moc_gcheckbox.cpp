...
struct qt_meta_stringdata_CLASS_Internal_QCheckBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QCheckBoxENDCLASS = QtMocHelpers::stringData(
    "_Internal_QCheckBox",
    "doubleClicked",
    "",
    "handleStateChange"
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QCheckBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QCheckBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QCheckBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QCheckBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QCheckBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QCheckBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QCheckBoxENDCLASS.stringdata0))
