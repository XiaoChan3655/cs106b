...
struct qt_meta_stringdata_CLASS_Internal_QTextBrowserENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QTextBrowserENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QTextBrowserENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QTextBrowser::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QTextBrowserENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QTextBrowserENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QTextBrowserENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QTextBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QTextBrowserENDCLASS.stringdata0))
