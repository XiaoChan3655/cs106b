...
struct qt_meta_stringdata_CLASS_Internal_QPushButtonENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QPushButtonENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QPushButtonENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QPushButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QPushButtonENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QPushButtonENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QPushButtonENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QPushButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QPushButtonENDCLASS.stringdata0))
