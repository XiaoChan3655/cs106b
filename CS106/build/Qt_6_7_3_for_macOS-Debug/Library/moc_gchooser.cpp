...
struct qt_meta_stringdata_CLASS_Internal_QComboBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QComboBoxENDCLASS = QtMocHelpers::stringData(
    "_Internal_QComboBox",
    "handleChange",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QComboBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QComboBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QComboBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QComboBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QComboBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QComboBoxENDCLASS.stringdata0))
