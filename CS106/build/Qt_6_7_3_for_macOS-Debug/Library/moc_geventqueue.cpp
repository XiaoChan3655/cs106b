...
struct qt_meta_stringdata_CLASSGEventQueueENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGEventQueueENDCLASS = QtMocHelpers::stringData(
    "GEventQueue",
    "eventReady",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGEventQueueENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject GEventQueue::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSGEventQueueENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGEventQueueENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGEventQueueENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *GEventQueue::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGEventQueueENDCLASS.stringdata0))
