...
struct qt_meta_stringdata_CLASS_Internal_QSliderENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QSliderENDCLASS = QtMocHelpers::stringData(
    "_Internal_QSlider",
    "handleChange",
    "",
    "value"
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QSliderENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QSlider::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QSliderENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QSliderENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QSliderENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QSliderENDCLASS.stringdata0))
