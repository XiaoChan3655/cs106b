...
struct qt_meta_stringdata_CLASS_Internal_QContainerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QContainerENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QContainerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QContainer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QContainerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QContainerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QContainerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QContainerENDCLASS.stringdata0))
