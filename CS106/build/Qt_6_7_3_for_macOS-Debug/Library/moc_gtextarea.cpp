...
struct qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS = QtMocHelpers::stringData(
    "_Internal_QTextEdit",
    "handleScroll",
    "",
    "value",
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QTextEditENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QTextEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QTextEditENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QTextEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QTextEditENDCLASS.stringdata0))
