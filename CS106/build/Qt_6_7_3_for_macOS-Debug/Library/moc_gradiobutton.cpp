...
struct qt_meta_stringdata_CLASS_Internal_QRadioButtonENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QRadioButtonENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QRadioButtonENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QRadioButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QRadioButtonENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QRadioButtonENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QRadioButtonENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QRadioButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QRadioButtonENDCLASS.stringdata0))
