...
struct qt_meta_stringdata_CLASS_Internal_QLineEditENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QLineEditENDCLASS = QtMocHelpers::stringData(
    "_Internal_QLineEdit",
    "handleTextChange",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QLineEditENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QLineEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QLineEditENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QLineEditENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QLineEditENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QLineEditENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASS_Internal_QSpinBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QSpinBoxENDCLASS = QtMocHelpers::stringData(
    "_Internal_QSpinBox",
    "handleTextChange",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QSpinBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QSpinBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QSpinBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QSpinBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QSpinBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QSpinBoxENDCLASS.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(this);
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASS_Internal_QDoubleSpinBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASS_Internal_QDoubleSpinBoxENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASS_Internal_QDoubleSpinBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QDoubleSpinBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASS_Internal_QDoubleSpinBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASS_Internal_QDoubleSpinBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASS_Internal_QDoubleSpinBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASS_Internal_QDoubleSpinBoxENDCLASS.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "_Internal_QWidget"))
        return static_cast< _Internal_QWidget*>(this);
